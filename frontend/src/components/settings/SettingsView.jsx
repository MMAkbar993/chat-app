...
export default function SettingsView({ darkMode, onDarkMode, activeSection, onSelect, mobileHidden, onStartTour }) {
  ...
  return (
    <div className={`w-full md:w-96 shrink-0 ${mobileHidden ? 'hidden md:flex' : 'flex'} flex-col border-r overflow-y-auto pb-28 md:pb-0 ${dm ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-100'}`}>
      ...
      <div className="pb-8">
        ...
        <ListRow
          ...
          icon={icon('M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'bg-yellow-500')}
          label="FAQ"

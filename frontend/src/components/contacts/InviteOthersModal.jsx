...
export default function InviteOthersModal({ darkMode, onClose }) {
  ...
  const [message, setMessage] = useState(
    "Hi! I'd like to invite you to join Pulse, a verified chat platform built for the iGaming industry. Once you sign up, we can connect directly and start chatting securely."
  )

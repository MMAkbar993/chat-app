      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Quick action tiles — a plain row of circular buttons, not a padded card
                stretched across the panel's full (now much wider) width. The card wrapper was
                most of what read as "too much space" once this became a full pane. */}
            <div className="flex items-center justify-center gap-8 mb-4">
              {[
                ...
                <button key={label} onClick={fn} className="flex flex-col items-center gap-1.5">
                  <div className={`w-11 h-11 rounded-full flex items-center justify-center transition-colors ${dm ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-100 hover:bg-gray-200'}`}>

...
import { listMessages, sendMessage, removeMessage, removeMessageForMe, forwardMessage, toggleReactionHandler, editMessageHandler } from '../controllers/message.controller.js'
...
messageRouter.patch('/messages/:id', editMessageHandler)

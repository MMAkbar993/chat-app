...
DIDIT_API_KEY=...
DIDIT_WORKFLOW_ID=...
# Register a webhook destination (POST /v3/webhook/destinations/) once this domain is live,
# then set the returned secret_shared_key here. Until then, KYC status is picked up by polling.
